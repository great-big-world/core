...
public record SyncWorldEventS2C(int entityId, int eventId, BlockPos pos, int data) implements CustomPayload {
    ...
    public SyncWorldEventS2C(RegistryByteBuf buf) {
        this(buf.readInt(), buf.readInt(), buf.readBlockPos(), buf.readInt());
    }
